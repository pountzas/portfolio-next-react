...
function Jira(props: JiraProps) {
  ...
  return (
    <svg height={size} preserveAspectRatio="xMidYMid" width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 -30 255 285">
      ...
      <linearGradient id="b" x1="98.031%" x2="58.888%" href="#a" y1=".161%" y2="40.766%" />
      <linearGradient id="c" x1="100.665%" x2="55.402%" href="#a" y1=".455%" y2="44.727%" />
