  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn more about Nikos Pountzas - a passionate full-stack web developer from Greece with expertise in React, Next.js, and modern web technologies."
        />
        <meta
          name="keywords"
          content="Nikos Pountzas, about, full-stack developer, Greece, web development, React, Next.js, TypeScript"
        />
        <meta property="og:title" content="About - Nikos Pountzas" />
        <meta
      ...
      <motion.div
        ...
        <motion.div className="text-center mb-12" variants={flipFromTop}>
          ...
          <motion.p
            ...
            Passionate full-stack developer with a background in graphic design, creating
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <motion.div
            ...
            <motion.p
              ...
              I{"'"}m Nikos Pountzas, a full-stack web developer from Greece with a unique
              blend of technical expertise and creative design skills.
            </motion.p>
            <motion.p
              className="text-textTertiary mb-3"
              variants={createStaggeredFlip(0.6, 0.1)(2)}>
              My journey began with graphic design studies, which gave me a strong
              foundation in visual communication and user experience principles.
            </motion.p>
            <motion.p
              className="text-textTertiary"
              variants={createStaggeredFlip(0.7, 0.1)(3)}>
              Today, I combine this creative background with modern web technologies to
              build engaging, user-centered applications.
            </motion.p>
          </motion.div>
        ...
        <motion.div
          ...
          <motion.p
            ...
            projects. Whether you need a modern web application, a responsive website, or
            technical consultation, I{"'"}d love to hear about your ideas.
          </motion.p>
          <motion.div
